...
# --- CONFIGURAZIONE DATABASE - VERSIONE DEFINITIVA ---
db_user = os.getenv('DB_USER')
db_pass = os.getenv('DB_PASS')
db_host = os.getenv('DB_HOST')
db_name = os.getenv('DB_NAME')

# Costruiamo la stringa di connessione a PostgreSQL
...
db = SQLAlchemy(app)
# Se usi Flask-Migrate, assicurati che sia inizializzato
# migrate = Migrate(app, db) 

# ... (resto della configurazione Mail, etc.) ...
